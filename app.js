...
var newSum1 = sum(a, b);
var newSum2 = sum(newSum1[0],c);
var product1 = multiply(a, b);
var product2 = multiply(product1[0],c);
return [newSum2[0], product2[0], `${a} and ${b} and ${c} sum to ${newSum2[0]}.`, `The product of ${a} and ${b} and ${c} is ${product2[0]}.` ];
}
...
var newSum3 = sum(sumArr[0], sumArr[1]);
var newSum4 = sum(newSum3[0], sumArr[2]);
return [newSum4[0], `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${newSum4[0]} is their sum.`];
}
...
var product3 = multiply(multArr[0], multArr[1])[0];
var product4 = multiply(product3, multArr[2])[0];
return [product4, `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${product4}.`]
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    for (var i =0; i<dynamicArray.length; i++) {
        product5 = multiply(dynamicArray[i], product5)[0]; 
    }
return [product5, `The numbers ${dynamicArray} have a product of ${product5}.`];    
}
